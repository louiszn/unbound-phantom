...
public class WanderAroundGoal extends Goal {
    ...
    public boolean canStart() {
        return ((IPhantomEntity) phantom).unbound$getMovementType() == PhantomMovementType.WANDER;
    }
    ...
    private double findGroundY(double x, double z) {
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            BlockPos ground = phantom.getEntityWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING, pos);
